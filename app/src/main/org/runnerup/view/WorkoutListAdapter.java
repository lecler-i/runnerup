...
class WorkoutListAdapter extends BaseAdapter {
  ...
  public Object getItem(int position) {
    ...
    if (position == workoutList.length) {
      return inflater.getContext().getString(org.runnerup.common.R.string.Auto_Generated);
    }
  ...
  public boolean isAutoGeneratedOption(String name) {
    return name != null
        && name.contentEquals(
            inflater.getContext().getString(org.runnerup.common.R.string.Auto_Generated));
  }

  public boolean isManageWorkoutsOption(String name) {
    if (name == null) {
      return false;
    }
  ...
  public boolean hasSavedWorkouts() {
    return workoutList.length > 0;
  }
